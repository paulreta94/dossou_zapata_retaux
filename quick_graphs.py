...
plt.plot(
    contenu_inertiel["temps_s"][0][0:150000],
    contenu_inertiel["inc_vit_x_ms"][0][0:150000],
    # "o",
    ls="-",
    # ms=4,
)
# for ax, key in zip(axs.flat, contenu_inertiel.keys()):
#     ax.set_title(f"markevery={key}")
#     ax.plot(contenu_inertiel["temps_s"], contenu_inertiel[key], "o", ls="-", ms=4)
plt.show()
